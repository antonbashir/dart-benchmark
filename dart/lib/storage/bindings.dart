...
class BenchmarkBindings {
  ...
  late final ffi.Pointer<benchmark> _instance = _lookup<benchmark>('instance');

  benchmark get instance => _instance.ref;
  ...
  late final _functionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>('function');
  late final _function = _functionPtr
      .asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();

  void dart_run_benchmark(
    int count,
    int port,
  ) {
    return _dart_run_benchmark(
      count,
      port,
    );
  }

  late final _dart_run_benchmarkPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Uint32, Dart_Port)>>(
          'dart_run_benchmark');
  late final _dart_run_benchmark =
      _dart_run_benchmarkPtr.asFunction<void Function(int, int)>();

  late final addresses = _SymbolAddresses(this);
}

class _SymbolAddresses {
  final BenchmarkBindings _library;
  ...
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Int Function(__pid_t, ffi.Pointer<sched_param>)>>
  ...
  ffi.Pointer<benchmark> get instance => _library._instance;
  ffi.Pointer<
          ffi.NativeFunction<
              ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>
      get function => _library._functionPtr;
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Uint32, Dart_Port)>>
      get dart_run_benchmark => _library._dart_run_benchmarkPtr;
}
...
class initialization_args extends ffi.Struct {
  @ffi.Uint32()
  external int count;
...
class benchmark extends ffi.Struct {
  @pthread_t()
  external int main_thread_id;

  external pthread_mutex_t completion_mutex;

  external pthread_cond_t completion_condition;

  @ffi.Bool()
  external bool completed;
}

class message extends ffi.Struct {
